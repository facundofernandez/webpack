...
function createPlaybackSession(config) {
    ...
    appendJS([
        ...
        mPlayerRoot + "/videojs-contrib-quality-levels/dist/videojs-contrib-quality-levels.min.js",
...
function playerReady(options) {
    ...
    if (!isMobile()) {
        ...
        qualityLevels.setPlayer(player);
        qualityLevels.init();
    }
...
function initIma() {
    ...
    player.on("adsready", function (e) {
        ...
        player.ima.addEventListener(google.ima.AdEvent.Type.STARTED, function (event) {
            ...
            player.ima.controlsDiv.style.display = "none";
...
function ImaDai() {
    ...
    function initStreamManager() {
        ...
        _this.player.textTracks().on('addtrack', function (e) {
    ...
    function onStreamEvent(e) {
        ...
        switch (e.type) {
            ...
            case google.ima.dai.api.StreamEvent.Type.LOADED:
                ...
                //var ad = e.getStreamData();

                //console.log("ad:", ad.streamId, ad.url);
    ...
    function addContentAdClick() {
        ...
        _this.player.el_.parentNode.insertBefore(divAdClick, _this.player.nextSibling);
    ...
    function trackEventImaDai() {
        ...
        for (let event in google.ima.dai.api.StreamEvent.Type) {
            ...
            _this.streamManager.addEventListener(google.ima.dai.api.StreamEvent.Type[event], function (e) {
                console.log(google.ima.dai.api.StreamEvent.Type[event], e);
                // Inicia video al terminar ads
            });
        }
    }
    ...
    ImaDai.prototype.setPlayer = setPlayer;
...
function QualityLevels() {
    ...
    function init() {
        ...
        _this.qualityLevels = _this.player.qualityLevels();
    ...
    QualityLevels.prototype.setPlayer = setPlayer;
    QualityLevels.prototype.init = init;
    QualityLevels.prototype.isMobile = isMobile;
